...
public class ComponentPart 
{
	...
	public String getPartType()			{ return this.PartType; }
	...
	public String toString() {
		return "Manufacturer: "+this.Manufacturer+" | Car Order details: "+
				this.PartType+" "+this.ID+" | Compatibility: "+this.Compatibility+
				" | Classification: "+this.Cost+" | Engine: "+this.IsRequired;
	}
}
